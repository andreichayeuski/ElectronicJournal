...
namespace EJ.Models.Interfaces
{
    public interface IUserTwoFactorTokenProvider<TUser> where TUser : class
    {
        ...
        /// </remarks>
        Task<string> GenerateAsync(string purpose, User user/*, IDataProtector protector*/);
        ...
        /// </returns>
        Task<IdentityResult> ValidateAsync(string purpose, string token, User user/*, IDataProtector protector*/);
