...
{
    public static class RusNumberPhrase
    {
        ...
        private static decimal AppendPeriod(this decimal value, long power, StringBuilder str, string declension1,
            string declension2, string declension5, bool male)
        {
        ...
        public static string RusSpelledOut(this decimal value, bool male, string valueDeclensionFor1,
            string valueDeclensionFor2, string valueDeclensionFor5)
        {
            return
