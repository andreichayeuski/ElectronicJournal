...
namespace EJ.Web.Controllers
{
    public class SheduleController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            return View("~/Areas/Shedule/Views/Index.cshtml", sheduleDate);
        }
        ...
        public IActionResult GetShedule(string sheduleDate)
        {
            ...
            return PartialView("~/Areas/Shedule/Views/_CalendarSheduleTimeSpendings.cshtml", model.Lessons);
        }

        [Authorize(Roles = "Староста, Заместитель старосты")]
        public IActionResult GetAbsence(LessonViewModel lesson)
        {
            var model = _sheduleService.GetAbsence(lesson);
            return PartialView("~/Areas/Shedule/Views/_Absences.cshtml", model);
        }
        ...
        {
            return PartialView("~/Areas/Shedule/Views/_AbsencesDates.cshtml", _sheduleService.GetSemesterDate());
        }
